...
Use the following information to understand how to create your document:
    - create your file under `.opencode/plans/YYYY-MM-DD_HH-MM-SS_description.md`, where:
...
### 2. Handoff writing.
using the above conventions, write your document. use the defined filepath, and the following YAML frontmatter pattern. Structure the document with YAML frontmatter followed by content:
...
### 3. Save the Document
The document is automatically saved to the plans directory. No additional sync command is needed.
...
<template_response>
Handoff created! You can resume from this handoff in a new session by reading the handoff document directly from the plans directory.
</template_response>
