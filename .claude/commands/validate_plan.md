...
3. **Investigate the implementation directly** — read files, run git commands, and check code yourself:
   ...
   Only spawn a subagent when you need to do a deep investigation of a *specific finding* (e.g., tracing a subtle bug through multiple files) — not for the overall validation work.
...
4. `/describe_mr` - Generate MR description
